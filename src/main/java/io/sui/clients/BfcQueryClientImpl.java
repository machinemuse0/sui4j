...
public class BfcQueryClientImpl implements QueryClient {
  ...
  public CompletableFuture<PaginatedObjectsResponse> getOwnedObjects(
    ...
    final JsonRpc20Request request =
        this.jsonRpcClientProvider.createJsonRpc20Request(
            "bfcx_getOwnedObjects", Lists.newArrayList(address, query, cursor, limit));
    return this.jsonRpcClientProvider.callAndUnwrapResponse(
        "/bfcx_getOwnedObjects", request, new TypeToken<PaginatedObjectsResponse>() {}.getType());
  }
  ...
  public CompletableFuture<Balance> getBalance(String address, String coinType) {
    ...
    final JsonRpc20Request request =
        this.jsonRpcClientProvider.createJsonRpc20Request(
            "bfcx_getBalance", Lists.newArrayList(address, coinType));
    return this.jsonRpcClientProvider.callAndUnwrapResponse(
        "/bfcx_getBalance", request, new TypeToken<Balance>() {}.getType());
  }
